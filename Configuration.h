...
#define CUSTOM_MACHINE_NAME "DualEx"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 1600, 95.88}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 225, 225, 3, 250}
 ...
 * You must activate one of these to use Leveling below.
 */
...
//#define Z_HOMING_HEIGHT 2.5  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
